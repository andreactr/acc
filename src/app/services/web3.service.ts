    ...
    constructor() {
        const providerOptions = {
            walletconnect: {
              ...
              options: {
                infuraId: "wss://ropsten.infura.io/ws/v3/e4a7fc6725924fe3b3d69d19b3fb15af" // required
              }
            }
          };
